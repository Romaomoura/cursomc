...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.romaomoura.cursospringmvc.resources"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
                "API do curso Spring Boot com ionic",
                "Esta API é utilizada no curso de Spring Boot com Ionic do prof. Nelio Alves",
                "Versão 1.0",
                "https://www.udemy.com/terms",
                new Contact("Romão moura", "udemy.com/user/nelio-alves", "c.romaomoura@gmail.com"),
